...
export default function multiplayerPage() {
	...
	p2Container.className = "flex flex-col";

	const playersContainer = document.createElement("div");
	playersContainer.className = "flex flex-wrap flex-1 justify-evenly gap-[2em]";

	playersContainer.append(p1Container, p2Container);
